				...
				<table class="form-table">
					...
					<tr><th scope="row"><?php esc_html_e( 'Label', 'backtothetop' ); ?></th>
						<td>
							...
							<label><input type="text" name="back_to_the_top_options[label]" value="<?php esc_attr( $options['label'] ); ?>" size="32"></label>
